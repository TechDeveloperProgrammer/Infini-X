...
# install-dotfiles.sh
# This script is run on the installed system by the new user to set up dotfiles.
...
# Dotfiles scripts
ln -sf "$DOTFILES_DIR/hypr/scripts/screenshot.sh" "$CONFIG_DIR/hypr/scripts/screenshot.sh"
ln -sf "$DOTFILES_DIR/hypr/scripts/volume.sh" "$CONFIG_DIR/hypr/scripts/volume.sh"
ln -sf "$DOTFILES_DIR/hypr/scripts/brightness.sh" "$CONFIG_DIR/hypr/scripts/brightness.sh"
